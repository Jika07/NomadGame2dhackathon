...
public class bowAndArrow : MonoBehaviour {
	...
	public void showArrows() {
		arrowText.text = "Стрелы: " + arrows.ToString ();
	}
	...
	public void createArrow(bool hitTarget) {
		...
		if (arrows > 0) {
			...
			endscoreText.text = "Вы стреляли всеми стрелами и забили " + score + " очки.";
		}
	}
	...
	public void setPoints(int points){
		...
		if (points == 50) {
			...
			rt1.GetComponent<TextMesh>().text= "Бонус";
		}
	}
	...
	public void showHighscore() {
		...
		actualHighscoreText.text = "Фиктический рекорд: " + PlayerPrefs.GetInt ("Score") + " points";
		newHighscoreText.text = "Ваш счет: " + score + " очков";
